...
if(isset($_POST['delete_product'])) {
    ...
    $getProductImageDeatil = mysqli_query($connection, $getProductImageId);
    ...
    while ($row = mysqli_fetch_assoc($getProductImageDeatil)) {
        ...
        $query_delete_image = mysqli_query($connection, $sql_delete_image);
    ...
    $query_delete_product = mysqli_query($connection, $sql_delete_product);
